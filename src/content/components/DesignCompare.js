...
const DesignCompare = ({setTabOpen, popupOnRight}) => {
  ...
  useEffect(() => {
    if (image) {
      ...
      img.className = "whole-page-preview";
  ...
  return (
    <div className={`element-design-overlay ${popupOnRight ? "popup-right" : "popup-left"}`}>
      <button className="close-design-btn" onClick={() => setTabOpen(state => ({...state, design: false}))}>Close</button>
